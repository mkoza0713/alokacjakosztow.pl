...
if(isset($_POST['nowe_zadanie'])){
    $nowy_klient_do_bazy = $_POST['nowe_zadanie'];
    ...
    if($walidacja_formularza){
        ...
        if($polaczenie1->connect_error!=0){
            ...
            $zapytanieSql1 = "INSERT INTO zadania VALUES (NULL, '$organizacja_usera', '$nowy_klient_do_bazy')";
            if($wynik_zapytania1 = $polaczenie1->query($zapytanieSql1)){
                header('Location:dodanieZadania.php');
...
if(isset($_POST['wiadomosc'])){
    ...
    $polaczenie2 = @new mysqli($host, $db_user, $db_password, $db_name);
        if($polaczenie2->connect_error!=0){
            ...
            $zapytanieSql2 = "DELETE FROM zadania WHERE id='$id_do_usuniecia'";
